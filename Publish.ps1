...
param (
    ...
    ## => User Config <= ## 
    $ProjectPath = "SmoothAnalogMovement.csproj",
    $PackageName = "SmoothAnalogMovement",
    ...
    $GitHubRepoName = "p5spc.SmoothAnalogMovement", # Name of the GitHub repo where the mod is contained
    ...
    $GameBananaItemId = 429128, # From mod page URL.

    $NuGetPackageId = "SmoothAnalogMovement",
